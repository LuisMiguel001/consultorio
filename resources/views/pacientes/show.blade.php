                    ...
                    <div class="card mb-3 shadow-sm">
                        ...
                        <div class="card-body">
                            @if ($ant->antecedentes_personales)
                                <p><strong>Personales:</strong><br>{{ $ant->antecedentes_personales }}</p>
                            @endif
                            @if ($ant->antecedentes_familiares)
                                <p><strong>Familiares:</strong><br>{{ $ant->antecedentes_familiares }}</p>
                            @endif
                            @if ($ant->antecedentes_quirurgicos)
                                <p><strong>Quirúrgicos:</strong><br>{{ $ant->antecedentes_quirurgicos }}</p>
                            @endif
                            @if ($ant->alergias)
                                <p><strong>Alergias:</strong><br>{{ $ant->alergias }}</p>
                            @endif
                            @if ($ant->medicamentos_actuales)
                                <p><strong>Medicamentos:</strong><br>{{ $ant->medicamentos_actuales }}</p>
                            @endif
                            @if ($ant->habitos)
                                <p><strong>Hábitos:</strong><br>{{ $ant->habitos }}</p>
                            @endif
                        </div>
                    </div>
                @empty
                    <div class="alert alert-secondary">No hay antecedentes registrados.</div>
                @endforelse
            </div>
                ...
                <div class="container-fluid py-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p>{{ $paciente->telefono ?? 'No especificado' }}<br>{{ $paciente->email ?? 'No especificado' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="border p-2 rounded bg-light small">{{ $ultimoAntecedente->antecedentes_personales }}</p>
                                </div>
                                @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="border p-2 rounded bg-light small">{{ $ultimoAntecedente->antecedentes_familiares }}</p>
                                </div>
                                @endif
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body p-3">
                                ...
                                @if($consulta->evoluciones->isNotEmpty())
                                    ...
                                    <div class="mb-2">
                                        <h6 class="text-primary small">Evolución - {{ $evolucion->created_at->format('d/m/Y H:i') }}</h6>
                                        <p class="border p-2 rounded bg-light small">{{ $evolucion->descripcion }}</p>
                                    </div>
                                    @endforeach
                                @endif
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="card mb-2 border-start border-3 @if($evento['tipo'] == 'Consulta') border-primary @elseif($evento['tipo'] == 'Diagnóstico') border-success @elseif($evento['tipo'] == 'Medicamento') border-warning @else border-info @endif">
