...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3 mb-0">Editar Plan: {{ $plane->nombre }}</h1>
            <p class="text-muted">Modifica la configuración del plan de suscripción</p>
        </div>
        <div class="col-auto">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('planes.update', $plane) }}" method="POST" id="plan-form">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                           id="nombre" name="nombre" value="{{ old('nombre', $plane->nombre) }}" required>
                                    @error('nombre')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                              id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $plane->descripcion) }}</textarea>
                                    @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('precio_mensual') is-invalid @enderror"
                                                   id="precio_mensual" name="precio_mensual" value="{{ old('precio_mensual', $plane->precio_mensual) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('precio_anual') is-invalid @enderror"
                                                   id="precio_anual" name="precio_anual" value="{{ old('precio_anual', $plane->precio_anual) }}" required>
                                            @error('precio_anual')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('caracteristicas') is-invalid @enderror"
                                           ...
                                           value="{{ old('caracteristicas', implode(', ', $plane->caracteristicas ?? [])) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_doctores') is-invalid @enderror"
                                                   id="max_doctores" name="max_doctores" value="{{ old('max_doctores', $plane->max_doctores) }}" placeholder="Dejar vacío = ilimitado">
                                            @error('max_doctores')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_secretarias') is-invalid @enderror"
                                                   id="max_secretarias" name="max_secretarias" value="{{ old('max_secretarias', $plane->max_secretarias) }}" placeholder="Dejar vacío = ilimitado">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_enfermeras') is-invalid @enderror"
                                                   id="max_enfermeras" name="max_enfermeras" value="{{ old('max_enfermeras', $plane->max_enfermeras) }}" placeholder="Dejar vacío = ilimitado">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_pacientes') is-invalid @enderror"
                                                   id="max_pacientes" name="max_pacientes" value="{{ old('max_pacientes', $plane->max_pacientes) }}" placeholder="Dejar vacío = ilimitado">
                                            @error('max_pacientes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_citas') is-invalid @enderror"
                                                   id="max_citas" name="max_citas" value="{{ old('max_citas', $plane->max_citas) }}" placeholder="Dejar vacío = ilimitado">
                                            @error('max_citas')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_consultas') is-invalid @enderror"
                                                   id="max_consultas" name="max_consultas" value="{{ old('max_consultas', $plane->max_consultas) }}" placeholder="Dejar vacío = ilimitado">
                                            @error('max_consultas')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_mensajes_whatsapp') is-invalid @enderror"
                                                   id="max_mensajes_whatsapp" name="max_mensajes_whatsapp" value="{{ old('max_mensajes_whatsapp', $plane->max_mensajes_whatsapp ?? 0) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="permite_archivar" name="permite_archivar" value="1" {{ $plane->permite_archivar ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="permite_recordatorios" name="permite_recordatorios" value="1" {{ $plane->permite_recordatorios ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="permite_whatsapp" name="permite_whatsapp" value="1" {{ $plane->permite_whatsapp ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="permite_reportes_avanzados" name="permite_reportes_avanzados" value="1" {{ $plane->permite_reportes_avanzados ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="permite_multiple_consultorios" name="permite_multiple_consultorios" value="1" {{ $plane->permite_multiple_consultorios ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check mb-2 ms-3">
                                            <input class="form-check-input module-checkbox" type="checkbox"
                                                   ...
                                                   {{ in_array($key, $plane->modulos_habilitados ?? []) ? 'checked' : '' }}>
